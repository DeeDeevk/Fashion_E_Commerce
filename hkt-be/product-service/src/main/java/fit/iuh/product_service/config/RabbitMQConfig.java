...
public class RabbitMQConfig {
    ...
    @Bean public DirectExchange productExchange() { return new DirectExchange(PRODUCT_EXCHANGE); }
    @Bean public Queue productSyncQueue() { return QueueBuilder.durable(PRODUCT_QUEUE).build(); }
    @Bean public Binding productSyncBinding(Queue productSyncQueue, DirectExchange productExchange) {

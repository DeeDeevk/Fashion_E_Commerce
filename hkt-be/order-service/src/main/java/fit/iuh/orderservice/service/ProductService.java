...
import fit.iuh.orderservice.dto.response.CategoryResponse;
import fit.iuh.orderservice.dto.response.ProductResponse;
import fit.iuh.orderservice.dto.response.ProductResponse.SizeDetailResponse;
import fit.iuh.orderservice.dto.response.TopProductResponse;
import fit.iuh.orderservice.entities.Category;
...
import fit.iuh.orderservice.enums.Status;
import fit.iuh.orderservice.exception.AppException;
import fit.iuh.orderservice.exception.ErrorCode;
import fit.iuh.orderservice.mapper.ProductMapper;
import fit.iuh.orderservice.repository.CategoryRepository;

...
export default function Employees() {
  ...
  const loadCustomers = async () => {
    ...
    try {
      ...
      const res = await fetch(`${BASE_URL}/accounts?${params.toString()}`, {
        headers: {
  ...
  const createCustomer = async () => {
    ...
    try {
      ...
      const res = await fetch(`${BASE_URL}/accounts/admin/add`, {
        method: "POST",
        headers: {
          Authorization: `Bearer ${token}`,
          "Content-Type": "application/json",
  ...
  const updateCustomer = async () => {
    ...
    try {
      ...
      const res = await fetch(
        `${BASE_URL}/accounts/admin/update/${editingAccount.id}`,
        {
          method: "PUT",
          headers: {
            Authorization: `Bearer ${token}`,
  ...
  const blockAccount = async (account) => {
    try {
      ...
      const res = await fetch(
        `${BASE_URL}/accounts/admin/delete/${account.id}`,
        {
          method: "DELETE",
          headers: {
            Authorization: `Bearer ${token}`,
  ...
  const handleCreateMeeting = async (meetingData) => {
    try {
      ...
      const res = await fetch(`${BASE_URL}/accounts/meetings/create`, {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
          Authorization: `Bearer ${token}`,
          ...
          <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
            <div>
              ...
              <p className="text-gray-500 mt-1">
                Manage and track your employees
              </p>
            </div>
